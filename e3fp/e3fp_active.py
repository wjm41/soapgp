...
def main(task, samp, split, seed, n_iter):
    ...
    print(task+' active learning with E3FP-GP, '+samp+' sampling, '+split+' splitting, seed = '+str(seed))
    ...
    np.save('results/e3fp_'+task+'_samp_'+samp+'_split_'+split+'_seed_'+str(seed)+'.npy', rmse_list)
