...
def main(task, samp, split, seed, n_iter):
    ...
    print(task+' active learning with ECFP-GP, '+samp+' sampling, '+split+' splitting, seed = '+str(seed))
    ...
    rem_mat = np.load('/rds-d2/user/wjm41/hpc-work/kernels/ecfp/'+task+'_2048.npy')
    ...
    np.save('results/ecfp_'+task+'_samp_'+samp+'_split_'+split+'_seed_'+str(seed)+'.npy', rmse_list)
